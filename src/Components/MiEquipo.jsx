      ...
      {shields.map(({ id, Componente }) => (
        <button
          ...
          className={`p-2 border-2 rounded ${
            selectedShield === id ? "border-yellow-400" : "border-gray-600"
          }`}
        >
          <Componente
            className="w-32 h-32"
    ...
    <div className="flex flex-wrap justify-center gap-4 mb-4">
      {rellenos.map(({ id, Componente }) => (
        <button
          ...
          className={`p-2 border-2 rounded ${
            selectedFill === id ? "border-yellow-400" : "border-gray-600"
          }`}
        >
          <Componente
            className="w-32 h-32"
        ...
        <div className="flex gap-2">
          {colores.map((color) => (
            <button
              ...
              style={{
                backgroundColor: color,
                border: secondaryColor === color ? "3px solid white" : "none",
              }}
            />
          ))}
        </div>
      ...
      <div className="mt-6">
        ...
        <div className="flex flex-col justify-center items-center">
          <input
            ...
            className="text-xl font-semibold border-2 p-2 mb-4 text-gray-200"
          />
          <button
